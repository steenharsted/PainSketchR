...
pdr_poly2points <- function(.data, paindrawr_data) {
  # We need to decide what to to with .points created from 
  # .polygons -- should we replace .points in pdr list-col 
  # or return it is a new list (of same length)?
